                        ...
                        <div class="d-flex justify-content-between align-items-center col-11">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" data-id="{{$content->id}}" class="favorite-post pt-2 mx-2">
                                    <svg class="icon icon-favorite" @if ($favorite_status)
                                        fill="red" @else fill="gray"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div>
                                                <a data-id="{{$comment->id}}" class="like-comment border-1 radius-5 pr-2 text-success" href="#"> <span
                                                        class="text-success pl-3">{{\App\Models\Contents\CommentsLikes::where('comments_id',$comment->id)->where('score','like')->count()}}</span>
                                                    <i class="fa fa-plus-square"></i>
                                                    </a>
                                                    <a data-id="{{$comment->id}}" class="dislike-comment border-1 radius-5 pr-2 text-danger mr-2" href="#"> <span
                                            ...
                                            <a href="#" data-name="{{$comment->members->firstname .' '.$comment->members->lastname }}" data-id="{{$comment->id}}" class="button__"> پاسخ
                                ...
                                <div class="mt-3">
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div>
                                            <a data-id="{{$comment_l2->id}}" class="like-comment border-1 radius-5 pr-2 text-success" href="#"> <span
                                                        class="text-success pl-3">{{\App\Models\Contents\CommentsLikes::where('comments_id',$comment_l2->id)->where('score','like')->count()}}</span>
                                                        <i class="fa fa-plus-square"></i>
                                                    </a>
                                                    <a data-id="{{$comment_l2->id}}" class="dislike-comment border-1 radius-5 pr-2 text-danger mr-2" href="#"> <span
                        ...
                        <div class="recommended-list">
                            <div class="inner">
                                ...
                                <div id="thumb" class="d-flex flex-md-wrap m-3 mx-md-0">
                                    <div class="w-40">
                                        @if ($related->picture)
                                      <a href="{{route('ShowItem',['id'=>$related->id])}}">  <img src="{{route('BaseUrl')}}/{{$related->picture}}" alt="{{$related->title}}"
                                        aria-label="{{$related->title}}" class="thumb-image"
                                        style="min-height: 130px;"></a>
                                        @else
                                        <a href="{{route('ShowItem',['id'=>$related->id])}}"><div class="d-flex justify-content-center align-items-center h-100 p-3" style="    border: 1px solid gray;
                                            border-radius: 4px;">
