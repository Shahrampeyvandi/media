															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	...
																	<img alt="logo" src="https://genebartar.ir/assets/images/logo.jpeg">
																		...
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">کاربر عزیز ژن برتر. لطفا به منظور بازیابی رمز عبور خود روی لینک زیر کلیک کنید.</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{ route('forgot.resetpass') }}?token={{$token}}" target="_blank">بازیابی رمز عبور</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
