    ...
    <div class="d-flex justify-content-between align-items-center col-12">
        ...
        <div class="d-flex align-items-center">
            ...
            <a class="downloadfile p-1 text-success mr-2 fs-0-8 radius-5 border-1 bc-theme" 
                                <?php if(Illuminate\Support\Facades\Route::currentRouteName()=='ShowItem.Episode' ): ?>
                            
                                href="<?php echo e(route('Download')); ?>?type=2&id=<?php echo e($episode_id); ?>"
                                
                                <?php else: ?>
                                
                                href="<?php echo e(route('Download')); ?>?type=1&id=<?php echo e($id); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\media\resources\views/Includes/Main/playerSubtitles.blade.php ENDPATH**/ ?>