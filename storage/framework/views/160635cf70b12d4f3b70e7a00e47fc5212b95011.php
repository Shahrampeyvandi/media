						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									<!-- // CENTERING TABLE -->
								<img src="https://genebartar.com/assets/images/email-bg.png" alt="">
								</td>
							</tr>
							<!-- // MODULE ROW -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="<?php echo e(route('Panel.Dashboard')); ?>?u=<?php echo e($member->username); ?>" target="_blank">ورود به ژن برتر</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
...
<?php /**PATH C:\xampp\htdocs\media\resources\views/emails/welcome.blade.php ENDPATH**/ ?>