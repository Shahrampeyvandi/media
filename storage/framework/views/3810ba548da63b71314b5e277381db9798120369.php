...
<div class="col-sm-12 col-sm-offset-3 col-md-12  ">
    ...
    <div class="row mb-3">
        <div class="col-md-12 card">
            <form id="advert" action="<?php echo e(route('Panel.Content.AddAdvert')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
 ...
 $.validator.addMethod(
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.Panel.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/AddContentAdvert.blade.php ENDPATH**/ ?>