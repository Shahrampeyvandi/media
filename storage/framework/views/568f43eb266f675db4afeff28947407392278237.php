																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						 کاربر عزیز ژن برتر! کد فعال سازی شما <?php echo e($code); ?> می باشد
																					</div>
																				</td>
																			</tr>
																		</table>
														...
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	...
																	<img alt="logo" src="https://genebartar.ir/assets/images/logo.jpeg">
																		...
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#205478;line-height:135%;">کاربر عزیز ژن برتر. لطفا به منظور ادامه ی روند ثبت نام خود از کد تایید زیر استفاده نمایید.</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" target="_blank">کد تایید: <?php echo e($code); ?></a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
...
<?php /**PATH C:\xampp\htdocs\media\resources\views/emails/activationcode.blade.php ENDPATH**/ ?>