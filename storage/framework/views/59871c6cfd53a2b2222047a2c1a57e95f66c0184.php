    ...
    <div class="col-md-12">
        <div class="card p-3">
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(route('Panel.EditAdvert')); ?>">ویرایش <i class="fa fa-pencil-alt"></i></a>
            </div>
            <form id="upload-file" method="post" action="<?php echo e(route('Panel.SaveAdvert')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.Panel.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/Income.blade.php ENDPATH**/ ?>