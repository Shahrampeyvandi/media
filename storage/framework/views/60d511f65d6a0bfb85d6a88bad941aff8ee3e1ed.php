...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(route('BaseUrl')); ?>/Panel/vendor/bootstrap/RTL.css">
...
<body>
  ...
  <script src="<?php echo e(route('BaseUrl')); ?>/Panel/vendor/jquery/jquery-3.4.1.js"></script>
  <script src="<?php echo e(route('BaseUrl')); ?>/Panel/assets/js/jquery.validate.js"></script>
    <?php echo $__env->yieldContent('js'); ?>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\Laravel\media\resources\views/layout/Login/template.blade.php ENDPATH**/ ?>