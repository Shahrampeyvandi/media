        ...
        <div class="position-relative">
            ...
            <div class="top"> <span class="pull-right m-t-n-xs m-r-sm text-white"> <i
               ...
               <?php if($music->picture): ?>
                <img src="<?php echo e(asset($music->picture)); ?>" width="100%;" height="230px" alt="" class="r r-2x img-full">
                <?php else: ?>
                <img src="<?php echo e(asset('assets/images/p4.jpg')); ?>" width="100%;" height="230px"  alt=""
...
<div class="row">
 ...
 </div><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/Components/musics.blade.php ENDPATH**/ ?>