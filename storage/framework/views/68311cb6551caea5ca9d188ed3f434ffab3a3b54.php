...
<div class="thumbnail-movie thumbnail-serial mx-3 card" style="max-width: 220px;">
 ...
 <div class="row">
    <div class="col-md-12">
     <a href="<?php echo e(route('UploadFile')); ?>?c=clips" class=" btn btn-sm btn-outline-info btn-rounded"><i class="fa fa-plus"></i> &nbsp; آپلود  </a>
    </div>
 </div><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/Components/clips.blade.php ENDPATH**/ ?>