        ...
        <div class="col-md-12 card" style="max-width:650px !important;margin-bottom: 2rem; ">
            ...
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <div class="">
                <form id="signupForm" action="<?php echo e(route('SignUp.Final')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php if($user): ?>
...
<?php echo $__env->make('layout.Login.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\media\resources\views/Login/register_step_three.blade.php ENDPATH**/ ?>