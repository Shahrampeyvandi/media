...
<div class="row">
    <div class="col-md-12">
        <div class="card p-3">
            ...
            <a href="<?php echo e(route('Panel.EditContactUs')); ?>">ویرایش <i class="fa fa-pencil-alt"></i></a>
            </div>
            <form id="upload-file" method="post" action="<?php echo e(route('Panel.SaveContactUs')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.Panel.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/ContactUs.blade.php ENDPATH**/ ?>