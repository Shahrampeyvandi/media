...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">
            ...
            فیلم و سریال
            <?php break; ?>
            <?php case ("panel/allposts/category/clips"): ?>
            ژن پلاس
            <?php break; ?>
            <?php case ("panel/allposts/category/animations"): ?>
            انیمیشن
            <?php break; ?>
            <?php case ("panel/allposts/category/musics"): ?>
            موسیقی
            <?php break; ?>
            <?php case ("panel/allposts/category/podcasts"): ?>
            پادکست
            <?php break; ?>
            
            <?php case ("panel/allposts/category/learnings"): ?>
            دوره ی آموزشی
            <?php break; ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="">
                            <a href="<?php echo e(route('Admin.CheckPost',$post->id)); ?>"
