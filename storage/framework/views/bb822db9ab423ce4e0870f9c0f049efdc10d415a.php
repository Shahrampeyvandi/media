    ...
    <div class="col-md-12">
        <div class="card p-3">
            ...
            <form id="upload-file" method="post" action="<?php echo e(route('Panel.SaveEditContactUs')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($contactus->id); ?>">
...
<?php echo $__env->make('layout.Panel.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\media\resources\views/Panel/EditContactUs.blade.php ENDPATH**/ ?>